...
public class AudioData {
	...
	/**
	 * cuts the audio file to a shorter version of length duration, starting at offset 60 seconds, or earlier if not possible at 60 sec.
	 * 
	 * @param duration
	 */
	...
	public void writeWavFile(String filename) {
		try {
			...
			WavFile wavFile = WavFile.newWavFile(new File(outputfilename), getChannels(), getSampleCount() / getChannels(), 16, getFrameRate());
